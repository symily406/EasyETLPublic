...
public class KillConsumer implements StreamListener<String, ObjectRecord<String, String>> {
    @Resource
    ...
    public void onMessage(ObjectRecord<String, String> message) {
        ...
        try {
            ...
            KillJob killJob = JsonKit.parseObject(messageBody, KillJob.class);
            killJobService.saveOrUpdateKillJob(killJob);
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
            redisStreamService.acknowledgeAndDelete(stream, GlobalConstant.consumerKillGroup, message);
        }
    }
}
