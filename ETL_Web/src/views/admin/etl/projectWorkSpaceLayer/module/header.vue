<template>
	<div class="headr-container">
		<el-form :inline="true" :model="queryParams">
			<el-form-item label="">
				<el-input v-model="queryParams.layerName" placeholder="名称" size="small" clearable></el-input>
			</el-form-item>
			...
			<el-form-item>
				...
				<el-button type="warning" size="small" icon="el-icon-edit" @click="add"
					v-if="checkPermission('admin:etl:projectWorkSpaceLayer:add')">新增</el-button>
			</el-form-item>
		</el-form>
	</div>
</template>
<script>
	...
	export default {
		name: 'projectWorkSpaceLayerHeader',
		components: {
